...
i386-elf-gcc -ffreestanding -m32 -g -c "bruh.c" -o "Binaries/bruh.o"
nasm "zeroes.asm" -f bin -o "Binaries/zeroes.bin"

i386-elf-ld -o "Binaries/full_kernel.bin" -Ttext 0x1000 "Binaries/kernel_entry.o" "Binaries/kernel.o" "Binaries/bruh.o" --oformat binary
